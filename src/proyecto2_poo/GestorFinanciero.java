...
public static void accederPerfil() {
    ...
    while(menu_secundario) {
        ...
        try {
            decision_secundaria = scanInt.nextInt();
        } catch(Exception e) {
            System.out.println("\n**ERROR** La decision ingresada debe ser un numero.");
            scanInt.nextLine();
            continue;
        ...
        switch(decision_secundaria) {
            ...
            case 2:{//Gastos
                ...
                while(menu_gastos) {
                    ...
                    try {
                        decision_gastos = scanInt.nextInt();
                    } catch(Exception e) {
                        System.out.println("\n**ERROR** La decision ingresada debe ser un numero.");
                        scanInt.nextLine();
                        continue;
            ...
            case 3:{//Ahorros
                ...
                while(menu_ahorros) {
                    ...
                    try {
                        decision_ahorros = scanInt.nextInt();
                    } catch(Exception e) {
                        System.out.println("\n**ERROR** La decision ingresada debe ser un numero.");
                        scanInt.nextLine();
                        continue;
...
public static void menuIngresos() {
    ...
    while(menu_ingresos) {
        System.out.println("\nMENU DE INGRESOS");
        System.out.println("Seleccione el numero correspondiente a su opcion: ");
        System.out.println("1. Registrar nuevo ingreso");
